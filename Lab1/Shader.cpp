...
void Shader::initGeo(const std::string& vertFile, const std::string& fragFile, const std::string& geomFile) 
{
	...
	shaders[2] = CreateShader(LoadShader(geomFile), GL_GEOMETRY_SHADER);
	...
	CheckShaderError(shaderID, GL_LINK_STATUS, true, "Error: Shader program linking failed"); 
